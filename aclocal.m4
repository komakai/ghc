...
[
    ...
    *-unknown-mingw32)
    ...
    x86_64-apple-darwin)
        $3='.dylib'
        ;;
    arm-apple-darwin10|i386-apple-darwin11|x86_64-apple-darwin11|aarch64-apple-darwin14)
        $3='.dylib'
        ;;
    esac
])
...
i386-apple-darwin) fptools_cv_leading_underscore=yes;;
...
case "$1-$2" in
  darwin10-arm|darwin11-i386|darwin11-x86_64|darwin14-aarch64)
    $3="ios"
    ;;
  *)
    case "$1" in
